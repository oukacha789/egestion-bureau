  ...
  return (
    <div className="bg-bx-900 border border-bx-800 rounded-xl p-4 flex flex-col gap-2 hover:border-bx-600 transition-colors duration-200">
      <div className="flex items-start justify-between">
        <span className="text-[10px] font-medium tracking-widest uppercase text-zinc-300 leading-none">
          {label}
        </span>
      ...
      {sub && (
        <span className="text-[10px] text-zinc-400 font-mono">{sub}</span>
      )}
    </div>
  );
}
      ...
      <div className="flex items-center justify-between px-5 h-11 border-b border-bx-800/80 shrink-0">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs text-zinc-200 hover:text-zinc-100 hover:bg-bx-800 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
          >
            <BarChart2 size={11} />
            Rapport
          </button>
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <div className="flex items-center gap-2 text-[11px] text-zinc-300">
                <Circle
                  size={6}
                  className={isWatching ? 'fill-emerald-400 text-emerald-400' : 'fill-zinc-600 text-zinc-400'}
                />
